(function () {
	...
	angular.module('sportsAdmin').factory('sportsApi', sportsApi);

	sportsApi.$inject = ['$http', 'appSpinner'];

	function sportsApi($http, appSpinner) {
		var service = {
			addLeague: addLeague,
		...
		var baseUrl = 'https://sports-schedule-admin.azure-mobile.net/tables';
		var requestConfig = {
			headers: {
				'X-ZUMO-APPLICATION': 'wyHEJKZHEVqFjoSytHFfwsfzIjmxgk17'
			}
		};
